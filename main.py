...
# Load Known faces
harrys_image = face_recognition.load_image_file("faces/img1.jpg")
harry_encoding = face_recognition.face_encodings(harrys_image)[0]

rohan_image = face_recognition.load_image_file("faces/img2.jpg")
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        #ada the text if a person is present
